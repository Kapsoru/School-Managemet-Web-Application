...
namespace Prescolaire.Data.Migrations
{
    ...
    [Migration("20240710174640_UpdateDataBaseSchoolYear")]
    partial class UpdateDataBaseSchoolYear
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Prescolaire.Models.SchoolYear", b =>
                {
                    b.Property<int>("SchoolYearId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Prescolaire.Models.Absence", b =>
                {
                    b.HasOne("Prescolaire.Models.SchoolYear", "SchoolYear")
                        .WithMany("Absences")
